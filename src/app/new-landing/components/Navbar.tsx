    ...
    >
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '1rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: '1.2rem', fontWeight: 700, color: 'hsl(240,20%,8%)' }}>Quantum Karma</span>
        </div>
      ...
      <style>{`.nl-nav-link { display: none !important; } @media(min-width:768px){.nl-nav-link{display:block!important}}`}</style>
    </motion.nav>
  );
}

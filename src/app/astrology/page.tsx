...
export default function Astrology() {
    ...
    return (
        <main className="min-h-screen bg-[#050505] text-white selection:bg-[#FFD700] selection:text-[#050505] font-sans">
            ...
            {/* 1.5. THE ARCHITECT OF MODERN PSYCHOLOGY */}
            <section className="py-24 px-6 bg-[#0a0500] border-t border-[#FFD700]/20 relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-[#FFD700]/5 via-transparent to-transparent opacity-60"></div>

                <div className="max-w-5xl mx-auto relative z-10">
                    <div className="inline-block border border-[#FFD700] bg-[#FFD700]/10 text-[#FFD700] px-3 py-1 rounded text-[10px] md:text-xs font-mono uppercase tracking-widest mb-8">
                        Declassified // The Secret Tool of Psychoanalysis
                    </div>

                    <h2 className="font-serif text-3xl md:text-5xl font-bold mb-8 text-white">
                        CARL JUNG'S OPEN SECRET
                    </h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="border-l-2 border-[#FFD700] pl-6 py-2">
                                <p className="font-serif text-[#FFD700] text-xl italic leading-snug">
                        ...
                        <div className="bg-black/50 border border-white/10 p-8 rounded-xl shadow-[0_0_50px_rgba(255,215,0,0.02)]">
                            <h3 className="font-mono text-sm uppercase tracking-widest text-white mb-4 border-b border-white/10 pb-4">The Psychological Reality</h3>
                            <ul className="space-y-4 font-light text-gray-400 text-sm">
                                ...
                                <li className="flex gap-3"><span className="text-[#FFD700] shrink-0 mt-1">✓</span> Created the concept of <strong>Synchronicity</strong> explicitly to explain astrological correlations.</li>
            ...
            {/* 4.5. THE BASTARDIZATION VS. THE MATHEMATICS */}
            <section className="py-32 px-6 bg-[#0a000f] border-t border-red-900/30">
                <div className="max-w-5xl mx-auto">
                    <h2 className="font-serif text-4xl md:text-6xl font-bold text-center mb-16 text-white tracking-tight">
                        THE COMMERCIALIZATION OF A SACRED SCIENCE
                    </h2>

                    <div className="grid md:grid-cols-2 gap-12 font-mono text-sm leading-relaxed text-gray-400 mb-24">
                        <div className="bg-black/40 border border-white/5 p-8 rounded-2xl relative">
                            <h3 className="text-red-500 font-bold uppercase tracking-widest mb-4">The Scam (Pop Astrology)</h3>
                            <p className="mb-4">
                                Over the last century, astrology was stripped of its mathematical rigor and sold to the masses as newspaper horoscopes and basic "Sun Sign" personality quizzes.
                            </p>
                            <p>
                        ...
                        <div className="bg-[#12011A] border border-[#FFD700]/20 p-8 rounded-2xl relative shadow-[0_0_30px_rgba(255,215,0,0.02)]">
                            <h3 className="text-[#FFD700] font-bold uppercase tracking-widest mb-4">The Sacred Reality</h3>
                    ...
                    {/* VEDIC DISCLAIMER / KARMA */}
                    <div className="bg-black border border-white/10 p-10 md:p-16 rounded-3xl text-center relative overflow-hidden">
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-[1px] bg-gradient-to-r from-transparent via-red-500 to-transparent"></div>

                        <h2 className="font-serif text-3xl md:text-5xl font-bold mb-8 text-white">
                            THE ABSOLUTE LAW OF KARMA
                        </h2>

                        <p className="font-mono text-lg md:text-xl text-red-500 font-bold mb-8 uppercase tracking-widest">
                            THERE IS NO GOD SITTING ON A CLOUD CONTROLLING YOUR LIFE.
                        </p>

                        <div className="space-y-6 text-gray-400 text-sm md:text-base leading-relaxed max-w-3xl mx-auto font-light">
                            <p>
                                As per the ancient Indian Vedic Scriptures, your birth chart is not a punishment or a reward distributed by a deity. <strong>It is a receipt.</strong>
                            </p>
                            <p>
                            ...
                            <p className="text-white font-bold text-lg mt-8 border-l-4 border-[#FFD700] inline-block px-4">
                                THE ONLY FREE WILL YOU HAVE IS YOUR REACTION.
                            </p>
                            <p>
                                You cannot change the storm, but you control how you sail the ship. The situations prescribed in your chart will happen. However, <strong>how you react to these situations is what paves your future and builds your new Karma.</strong> You retain absolute control over your conscious response.
                            </p>
                        </div>
                    </div>
                </div>

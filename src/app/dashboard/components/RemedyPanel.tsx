...
export default function RemedyPanel({ profileId, profileName }: Props) {
  ...
  useEffect(() => {
    async function checkSaved() {
      ...
      setConfirmed(false);
      try {
        const res  = await fetch(`/api/remedy?profileId=${profileId}`);
      ...
      <div className="h-full flex flex-col overflow-y-auto custom-scrollbar">
        ...
        <div className="flex-shrink-0 p-6 border-b border-slate-100 bg-gradient-to-r from-indigo-50 via-purple-50 to-slate-50">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 tracking-tight">Tantric Mantra Remedy</h2>
        ...
        <div className="flex-shrink-0 p-5 border-b border-slate-100 bg-gradient-to-r from-indigo-50 via-purple-50 to-slate-50">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-slate-900 tracking-tight">Tantric Mantra Remedy</h2>
